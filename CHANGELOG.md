...
- **A selector with four options stays on one line.** It counted the card's padding as room, so with the storm level showing, the fourth option wrapped under the other three. The settings column is also wide enough now for four options at full width.
