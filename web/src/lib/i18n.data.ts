...
export const en = {
  ...
  'overview.idle': 'Nothing is running.',
  'overview.idleHint': 'Jobs run on their schedule, or when you start one by hand.',
  'overview.accounts': 'Connected accounts',
  'overview.noSpace': 'This target does not say how full it is.',
  'overview.status': 'Sync status',
  'overview.lastSync': 'Last sync',
  'overview.uploaded': 'uploaded: {count}',
  'overview.downloaded': 'downloaded: {count}',
  'overview.changes': 'Last changes',
  'overview.finishedAt': 'Finished at',
  'overview.duration': 'Run time',
  'overview.seconds': '{count} seconds',
  'overview.state': 'State',
  'overview.nextSync': 'Next sync',
  'overview.byHand': 'by hand',
  'overview.files': '{count} files',
  'overview.uploadedLabel': 'Upload',
  'overview.downloadedLabel': 'Download',
  'overview.deletedHere': 'Deleted locally',
  'overview.deletedThere': 'Deleted on the target',
  ...
  'schedule.cron': 'Cron',
  'schedule.live': 'Transfer immediately',
  'schedule.liveHint': 'Changes on this device are sent as they happen, instead of waiting for the next scheduled run. Only the side on this device can be watched, so a change made on the other side still arrives with the schedule.',
  'schedule.settleHint': 'How long nothing may happen in the folder before an immediate transfer starts a run. Copy fifty files in and the system reports fifty changes, so with no wait that is fifty runs. Five seconds covers everyday use.',
  ...
  'entry.other': 'did',
  'entry.upload': 'Uploaded to {place}',
  'entry.download': 'Downloaded from {place}',
  'entry.copyTo': 'Copied to {place}',
  'entry.copyFrom': 'Copied from {place}',
  'entry.moveLocal': 'Moved locally',
  'entry.moveIn': 'Moved in {place}',
  'entry.trashLocal': 'Deleted locally',
  'entry.trashIn': 'Deleted in {place}',
  'entry.mkdirLocal': 'Folder made locally',
  'entry.mkdirIn': 'Folder made in {place}',
  'entry.rmdirLocal': 'Folder deleted locally',
  'entry.rmdirIn': 'Folder deleted in {place}',
  'entry.uploadFailed': 'Upload failed',
  'entry.downloadFailed': 'Download failed',
  'entry.failed': 'Failed',
  ...
  'targets.addCloud': 'Connect a cloud',
  'targets.addBucket': 'Add object storage',
  'targets.addServer': 'Add a server or share',
  ...
  'targets.check': 'Test connection',
  'targets.checking': 'Testing',
  ...
  'about.paypalOther': 'Other amount',
  ...
  'look.disco': 'Disco',
  'look.discoHint': 'All colours glide along the palette together, once round every 19 seconds.',
  ...
  'history.filterKind': 'What happened',
  'history.rangeReset': 'Clear the range',
  'history.until': 'To',
  'history.since': 'From',
  'history.showAll': 'Every run',
  'history.showChanged': 'Only runs that did something',
  'history.showFailed': 'Only errors',
  'history.files': 'Files',
  'history.runs': 'Runs',
  'history.filter': 'Filter',
  'history.everything': 'Everything',
  'history.onlyCopied': 'Copied',
  'history.onlyGone': 'Deleted',
  'history.onlyTrouble': 'Problems',
  'history.logEmpty': 'Nothing has been touched yet.',
  'history.perfectlyIdle': 'Nothing to do, and that is exactly right.',
  'history.pathHint': 'part of a name',
  ...
  'edit.commandsHint': 'Set in arrowloop.json and nowhere else: a command entered here would run on this machine with the program\'s rights. Saving the job here keeps them as they are.',
  'edit.before': 'Before',
  'edit.after': 'After',
  ...
  'phone.doze': 'Background activity',
  'phone.openBattery': 'Battery optimisation',
  'phone.dozeOff': 'Switch battery optimisation OFF for ArrowLoop. With it on, Android puts the app to sleep when the screen has been off for a while: a job set for the night then waits until you next pick the phone up, and an immediate transfer notices nothing until then.',
  ...
  'phone.engineBusy': 'The engine is running and has not answered yet. It is most likely busy, and this screen comes back on its own as soon as it does.',
  'phone.engineGone': 'The engine process is gone. It started and stopped, or never started at all.',
  'phone.engineNoModule': 'This build has no engine module.',
  ...
  'settings.app': 'App',
  'apps.phoneTitle': 'Phone app',
  'apps.phoneHint': 'The app runs ArrowLoop on the phone itself, so the phone\'s own photos and folders can take part in a job. The download is always the newest release.',
  'apps.desktopTitle': 'Desktop app',
  'apps.desktopHint': 'ArrowLoop as a program on the computer, with this interface in a window of its own. Every download is the newest release.',
  ...
  'apps.serverHint': 'ArrowLoop on a server, which keeps it running around the clock: from Unraid\'s Community Applications, as a Docker image, or built from its source code.',
  'apps.dockerHint': 'A click copies the command that starts it:',
  'apps.copied': 'Copied',
  'apps.zip': 'Source code.zip',
  'password.hint': 'Anyone who can reach this address can start jobs that delete files. The password is kept as a hash in security.json beside the configuration, so a settings backup never carries it. ARROWLOOP_PASSWORD_HASH, where it is set, wins over this password and is the way back in if it is forgotten.',
  'password.on': 'Authentication is enabled.',
  'password.off': 'Authentication is off. All LAN users have full access.',
  'password.env': 'Set through ARROWLOOP_PASSWORD_HASH. Change or remove it where the container or service is configured.',
  'password.current': 'Current password',
  'password.new': 'New password',
  'password.repeat': 'Confirm password',
  'password.minLength': 'Minimum length in characters: {count}',
  'password.mismatch': 'Passwords do not match',
  'password.currentNeeded': 'Enter the current password first.',
  'password.saveFirst': 'Set password',
  'password.saveChange': 'Change password',
  'password.saved': 'Password saved',
  'password.remove': 'Remove password',
  'password.removeTitle': 'Remove the password?',
  'password.removeStakes': 'Anyone who can reach this address can use ArrowLoop again, including starting jobs that delete files. Two-factor authentication goes with the password.',
  'password.removed': 'Authentication disabled',
  'twoFactor.title': 'Two-factor authentication',
  'twoFactor.hint': 'A code from your phone on top of the password. Worth turning on if this instance is reachable from outside your network.',
  'twoFactor.on': 'On. A code is needed as well as the password.',
  'twoFactor.off': 'Off. The password alone signs in.',
  'twoFactor.needsPassword': 'Set a login password first.',
  'twoFactor.add': 'Set up',
  'twoFactor.scan': 'Scan this with your authenticator app.',
  'twoFactor.secretManual': 'Or type this in by hand:',
  'twoFactor.confirmCode': 'Enter the code the app shows now',
  'twoFactor.confirm': 'Confirm',
  'twoFactor.codeInvalid': 'That code is not valid',
  'twoFactor.recoveryTitle': 'Recovery codes',
  'twoFactor.recoveryOnce': 'Write these down now. Each one works once, and they are not shown again.',
  'twoFactor.recoverySaved': 'I have written them down',
  'twoFactor.recoveryLeft': 'Recovery codes left: {count}',
  'twoFactor.remove': 'Turn off',
  'twoFactor.disableCodePrompt': 'Enter a current code to turn it off',
  'passkey.title': 'Passkeys',
  'passkey.hint': 'Sign in with the key on your phone, laptop or security stick instead of the password. Works only when you reach ArrowLoop through a host name with a certificate your browser trusts, which in practice means a reverse proxy.',
  'passkey.on': '{count} registered',
  'passkey.off': 'None registered',
  'passkey.needsPassword': 'Set a login password first. A passkey is an extra way in, never the only one.',
  'passkey.notHere': 'Not available on this address',
  'passkey.needsDomain': 'A passkey is tied to a host name, so a bare IP address cannot carry one, and neither can a page whose certificate the browser does not trust. Reach ArrowLoop through a reverse proxy under a real name with a valid certificate, open it there, and register the key on that address.',
  'passkey.noBrowser': 'This browser cannot do passkeys.',
  'passkey.usableHere': 'Works on this address',
  'passkey.otherAddress': 'For {host}, so it cannot be used here',
  'passkey.notSynced': 'Not synced, so it is gone if you lose the device.',
  'passkey.add': 'Set up',
  'passkey.nameLabel': 'Name',
  'passkey.namePlaceholder': 'Phone, laptop, security key',
  'passkey.create': 'Create',
  'passkey.defaultName': 'Passkey',
  'passkey.failed': 'The passkey could not be created',
  'passkey.remove': 'Remove',
  'passkey.removeTitle': 'Remove this passkey?',
  'passkey.removeStakes': '{name} will no longer sign you in. The password still works.',
  'login.code': 'Authentication code',
  'login.codeHint': 'Six digits from your authenticator app, or one of your recovery codes.',
  'login.passkeyUnlock': 'Sign in with a passkey',
...
export const de: Translations = {
  ...
  'overview.running': 'Läuft gerade',
  'overview.idle': 'Gerade läuft nichts.',
  'overview.idleHint': 'Aufträge laufen nach ihrem Zeitplan oder wenn du einen von Hand startest.',
  'overview.accounts': 'Verbundene Konten',
  'overview.noSpace': 'Dieses Ziel sagt nicht, wie voll es ist.',
  'overview.status': 'Synchronisationsstatus',
  'overview.lastSync': 'Zuletzt abgeglichen',
  'overview.uploaded': 'hochgeladen: {count}',
  'overview.downloaded': 'heruntergeladen: {count}',
  'overview.changes': 'Letzte Änderungen',
  'overview.finishedAt': 'Beendet um',
  'overview.duration': 'Laufzeit',
  'overview.seconds': '{count} Sekunden',
  'overview.state': 'Status',
  'overview.nextSync': 'Nächste Sync',
  'overview.byHand': 'von Hand',
  'overview.files': '{count} Dateien',
  'overview.uploadedLabel': 'Upload',
  'overview.downloadedLabel': 'Download',
  'overview.deletedHere': 'Lokal gelöscht',
  'overview.deletedThere': 'Vom Ziel gelöscht',
  ...
  'schedule.cron': 'Cron',
  'schedule.live': 'Sofort übertragen',
  'schedule.liveHint': 'Änderungen auf diesem Gerät werden übertragen, sobald sie passieren, statt auf den nächsten Zeitplan zu warten. Beobachtet werden kann nur die Seite auf diesem Gerät, eine Änderung auf der Gegenseite kommt also weiterhin erst mit dem Zeitplan.',
  'schedule.settleHint': 'Wie lange im Ordner nichts passieren darf, bevor die Sofortübertragung einen Lauf startet. Kopiere fünfzig Dateien hinein, meldet das System fünfzig Änderungen - ohne Wartezeit sind das fünfzig Läufe. Fünf Sekunden decken den Alltag ab.',
  ...
  'entry.upload': 'Nach {place} hochgeladen',
  'entry.download': 'Von {place} heruntergeladen',
  'entry.copyTo': 'Nach {place} kopiert',
  'entry.copyFrom': 'Von {place} kopiert',
  'entry.moveLocal': 'Lokal verschoben',
  'entry.moveIn': 'In {place} verschoben',
  'entry.trashLocal': 'Lokal gelöscht',
  'entry.trashIn': 'In {place} gelöscht',
  'entry.mkdirLocal': 'Ordner lokal angelegt',
  'entry.mkdirIn': 'Ordner in {place} angelegt',
  'entry.rmdirLocal': 'Ordner lokal gelöscht',
  'entry.rmdirIn': 'Ordner in {place} gelöscht',
  'entry.uploadFailed': 'Upload fehlgeschlagen',
  'entry.downloadFailed': 'Download fehlgeschlagen',
  'entry.failed': 'Fehlgeschlagen',
  'history.ok': 'Abgeschlossen',
  'history.failed': 'Fehler',
  ...
  'targets.addCloud': 'Cloud verbinden',
  'targets.addBucket': 'Objektspeicher anlegen',
  'targets.addServer': 'Server oder Freigabe anlegen',
  'targets.remoteName': 'Name',
  ...
  'targets.check': 'Verbindung testen',
  'targets.checking': 'Testet',
  ...
  'about.paypalOther': 'Anderer Betrag',
  ...
  'look.disco': 'Disco',
  'look.discoHint': 'Alle Farben wandern gemeinsam durch die Palette, einmal rundherum in 19 Sekunden.',
  ...
  'history.filterKind': 'Was passiert ist',
  'history.rangeReset': 'Zeitraum zurücksetzen',
  'history.until': 'Bis',
  'history.since': 'Von',
  'history.showAll': 'Alle Läufe',
  'history.showChanged': 'Nur Läufe, die etwas getan haben',
  'history.showFailed': 'Nur Fehler',
  'history.files': 'Dateien',
  'history.runs': 'Läufe',
  'history.filter': 'Filter',
  'history.everything': 'Alles',
  'history.onlyCopied': 'Kopiert',
  'history.onlyGone': 'Gelöscht',
  'history.onlyTrouble': 'Probleme',
  'history.logEmpty': 'Es wurde noch keine Datei angefasst.',
  'history.perfectlyIdle': 'Nichts zu tun, und genau das ist perfekt.',
  'history.pathHint': 'Teil eines Namens',
  ...
  'edit.commandsHint': 'Stehen nur in arrowloop.json: ein hier eingegebener Befehl liefe mit den Rechten des Programms auf diesem Rechner. Speichern hier lässt sie, wie sie sind.',
  'edit.before': 'Vorher',
  'edit.after': 'Nachher',
  ...
  'opt.host': 'Server',
  'opt.url': 'Adresse',
  'opt.urlHint': 'Die vollständige Adresse des Speichers, nicht nur der Name des Servers: der Pfad dahinter gehört dazu. Eine Cloud nennt ihn in ihren eigenen Einstellungen unter WebDAV.',
  'opt.userHint': 'Der Name, mit dem du dich anmeldest, nicht der Anzeigename und nicht die E-Mail. Ein App-Token wird mit genau diesem Namen benutzt.',
  'opt.passHint': 'Das Passwort dieses Kontos. Wo der Dienst App-Passwörter anbietet, ist eines davon sicherer: es lässt sich einzeln zurückziehen, ohne das Passwort zu ändern, das du überall sonst benutzt.',
  'opt.passCloudHint': 'Hier gehört ein App-Token hin, NICHT dein Anmeldepasswort. In der Cloud erzeugen (Nextcloud: Einstellungen, Sicherheit, App-Passwort erstellen. OpenCloud: Konto, App-Tokens), ganz kopieren und auf ein Leerzeichen am Ende achten. OpenCloud lehnt das Anmeldepasswort grundsätzlich ab, und ein Token lässt sich einzeln widerrufen, falls das Telefon einmal wegkommt.',
  'opt.hostHint': 'Name oder IP des Rechners, ohne http:// und ohne Pfad, also fileserver oder 192.168.1.20. Die Freigabe oder der Ordner gehört nicht dazu.',
  'opt.portHint': 'Nur nötig, wenn der Dienst nicht auf seinem üblichen Port liegt. Leer gelassen nimmt er den Standard: 22 bei SFTP, 445 bei einer Freigabe, 21 bei FTP.',
  'opt.tokenHint': 'Der Token, den der Dienst für diese App ausgestellt hat. Er wird nur einmal angezeigt, beim Anlegen, also ganz kopieren und auf ein Leerzeichen am Ende achten.',
  'opt.accessKeyHint': 'Die Schlüssel-ID des Objektspeichers, die kürzere Hälfte des Paares. Sie benennt das Konto und ist für sich allein kein Geheimnis. MinIO und Garage zeigen sie beim Anlegen des Schlüssels.',
  'opt.secretKeyHint': 'Die geheime Hälfte des Paares, einmalig beim Anlegen angezeigt. Wer sie hat, hat denselben Zugriff wie du: ist sie weg, lege einen neuen Schlüssel an, statt den alten zu suchen.',
  'opt.endpointHint': 'Nur bei einem Speicher, der nicht Amazon ist: die Adresse deines eigenen Servers mit Port, zum Beispiel http://192.168.1.20:9000. Für Amazon selbst bleibt das Feld leer.',
  'opt.regionHint': 'Die Region, in der der Eimer liegt, so geschrieben wie der Speicher sie schreibt. Selbst betriebene Speicher nehmen meist jedes Wort, und us-east-1 ist die sichere Wahl, wenn ihre Einrichtung keine nennt.',
  'opt.port': 'Port',
  'opt.domain': 'Domäne',
  ...
  'phone.doze': 'Hintergrundaktivität',
  'phone.openBattery': 'Akkuoptimierung',
  'phone.dozeOff': 'Schalte die Akkuoptimierung für ArrowLoop AUS. Mit ihr legt Android die App schlafen, sobald der Bildschirm eine Weile aus war: ein Auftrag für die Nacht wartet dann, bis du das Telefon das nächste Mal in die Hand nimmst, und eine Sofortübertragung bemerkt bis dahin nichts.',
  ...
  'phone.engineBusy': 'Der Motor läuft und hat noch nicht geantwortet. Vermutlich ist er beschäftigt; dieser Bildschirm verschwindet von selbst, sobald er antwortet.',
  'phone.engineGone': 'Der Motor-Prozess ist weg. Er wurde gestartet und wieder beendet, oder er ist nie gestartet.',
  'phone.engineNoModule': 'Dieser Bau hat kein Motor-Modul.',
  ...
  'settings.app': 'App',
  'apps.phoneTitle': 'Handy-App',
  'apps.phoneHint': 'Die App lässt ArrowLoop auf dem Handy selbst laufen, damit Fotos und Ordner des Handys an einem Auftrag teilnehmen können. Der Download ist immer die neueste Version.',
  'apps.desktopTitle': 'Desktop-App',
  'apps.desktopHint': 'ArrowLoop als Programm auf dem Rechner, mit dieser Oberfläche in einem eigenen Fenster. Jeder Download ist die neueste Version.',
  ...
  'apps.unraid': 'Unraid',
  'apps.docker': 'Docker',
  'apps.download': 'Herunterladen',
  'apps.qr': 'QR-Code',
  'apps.soon': 'Bald',
  'apps.serverTitle': 'Auf einem Server',
  'apps.serverHint': 'ArrowLoop auf einem Server, der es rund um die Uhr laufen lässt: aus den Community Applications von Unraid, als Docker-Image oder aus dem Quellcode gebaut.',
  'apps.dockerHint': 'Ein Klick kopiert den Befehl, der es startet:',
  'apps.copied': 'Kopiert',
  'apps.zip': 'Quellcode.zip',
  'password.hint': 'Wer diese Adresse erreicht, kann Aufträge starten, die Dateien löschen. Das Passwort liegt als Hash in security.json neben der Konfiguration, darum steckt es in keiner Sicherung der Einstellungen. Ist ARROWLOOP_PASSWORD_HASH gesetzt, gilt dieser Wert vor diesem Passwort und bringt dich wieder hinein, wenn du es vergessen hast.',
  'password.on': 'Authentifizierung ist aktiviert.',
  'password.off': 'Authentifizierung ist deaktiviert. Alle LAN-Nutzer haben vollen Zugriff.',
  'password.env': 'Kommt aus ARROWLOOP_PASSWORD_HASH. Ändern oder entfernen lässt es sich dort, wo der Container oder der Dienst eingerichtet ist.',
  'password.current': 'Aktuelles Passwort',
  'password.new': 'Neues Passwort',
  'password.repeat': 'Passwort bestätigen',
  'password.minLength': 'Mindestlänge in Zeichen: {count}',
  'password.mismatch': 'Passwörter stimmen nicht überein',
  'password.currentNeeded': 'Gib zuerst das aktuelle Passwort ein.',
  'password.saveFirst': 'Passwort setzen',
  'password.saveChange': 'Passwort ändern',
  'password.saved': 'Passwort gespeichert',
  'password.remove': 'Passwort entfernen',
  'password.removeTitle': 'Passwort entfernen?',
  'password.removeStakes': 'Dann kann jeder, der diese Adresse erreicht, ArrowLoop wieder benutzen und auch Aufträge starten, die Dateien löschen. Die Zwei-Faktor-Authentifizierung geht mit dem Passwort.',
  'password.removed': 'Authentifizierung deaktiviert',
  'twoFactor.title': 'Zwei-Faktor-Authentifizierung',
  'twoFactor.hint': 'Ein Code vom Handy zusätzlich zum Passwort. Lohnt sich, wenn diese Instanz von außerhalb deines Netzes erreichbar ist.',
  'twoFactor.on': 'An. Neben dem Passwort wird ein Code verlangt.',
  'twoFactor.off': 'Aus. Das Passwort allein genügt zum Anmelden.',
  'twoFactor.needsPassword': 'Setze zuerst ein Anmeldepasswort.',
  'twoFactor.add': 'Einrichten',
  'twoFactor.scan': 'Scanne das mit deiner Authenticator-App.',
  'twoFactor.secretManual': 'Oder tippe das hier von Hand ein:',
  'twoFactor.confirmCode': 'Gib den Code ein, den die App jetzt zeigt',
  'twoFactor.confirm': 'Bestätigen',
  'twoFactor.codeInvalid': 'Dieser Code ist ungültig',
  'twoFactor.recoveryTitle': 'Notfallcodes',
  'twoFactor.recoveryOnce': 'Schreib sie jetzt auf. Jeder funktioniert einmal, und sie werden nicht noch einmal angezeigt.',
  'twoFactor.recoverySaved': 'Ich habe sie aufgeschrieben',
  'twoFactor.recoveryLeft': 'Übrige Notfallcodes: {count}',
  'twoFactor.remove': 'Ausschalten',
  'twoFactor.disableCodePrompt': 'Gib zum Ausschalten einen aktuellen Code ein',
  'passkey.title': 'Passkeys',
  'passkey.hint': 'Statt des Passworts mit dem Schlüssel auf Handy, Rechner oder Sicherheitsstick anmelden. Geht nur, wenn du ArrowLoop über einen Rechnernamen mit einem Zertifikat erreichst, dem dein Browser traut, also in der Praxis über einen Reverse-Proxy.',
  'passkey.on': '{count} eingerichtet',
  'passkey.off': 'Keiner eingerichtet',
  'passkey.needsPassword': 'Richte zuerst ein Passwort ein. Ein Passkey ist ein zusätzlicher Weg hinein, nie der einzige.',
  'passkey.notHere': 'Auf dieser Adresse nicht möglich',
  'passkey.needsDomain': 'Ein Passkey hängt an einem Rechnernamen. Eine nackte IP-Adresse kann keinen tragen, und eine Seite mit einem Zertifikat, dem der Browser nicht traut, auch nicht. Erreiche ArrowLoop über einen Reverse-Proxy unter einem echten Namen mit gültigem Zertifikat, öffne es dort und richte den Schlüssel auf dieser Adresse ein.',
  'passkey.noBrowser': 'Dieser Browser kann keine Passkeys.',
  'passkey.usableHere': 'Funktioniert auf dieser Adresse',
  'passkey.otherAddress': 'Gehört zu {host} und lässt sich hier nicht verwenden',
  'passkey.notSynced': 'Nicht synchronisiert, also weg, wenn das Gerät weg ist.',
  'passkey.add': 'Einrichten',
  'passkey.nameLabel': 'Name',
  'passkey.namePlaceholder': 'Handy, Rechner, Sicherheitsschlüssel',
  'passkey.create': 'Anlegen',
  'passkey.defaultName': 'Passkey',
  'passkey.failed': 'Der Passkey konnte nicht angelegt werden',
  'passkey.remove': 'Entfernen',
  'passkey.removeTitle': 'Diesen Passkey entfernen?',
  'passkey.removeStakes': '{name} meldet dich dann nicht mehr an. Das Passwort funktioniert weiter.',
  'login.code': 'Anmeldecode',
  'login.codeHint': 'Sechs Ziffern aus deiner Authenticator-App oder einer deiner Notfallcodes.',
  'login.passkeyUnlock': 'Mit Passkey anmelden',
  'login.passkeyFailed': 'Dieser Passkey wurde nicht akzeptiert',
}
