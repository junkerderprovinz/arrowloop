...
export const en = {
  ...
  'phone.accessOn': 'ArrowLoop can reach the folders a job points at.',
  'phone.accessOff': 'Android keeps every app out of every other app\'s folders. Without this, a job reaches only the small corner that belongs to this app, which is not where the camera puts anything.',
  'phone.accessAsk': 'Allow file access',
  ...
  'phone.notifyOn': 'The engine can say when a run has finished and when one has gone wrong.',
  'phone.notifyOff': 'Without this, a run that failed at three in the morning is something you find out about days later.',
  'phone.notifyAsk': 'Allow notifications',
  'phone.doze': 'Running in the background',
  'phone.dozeOn': 'Android leaves timed runs alone.',
  ...
  'phone.dozeAsk': 'Allow running in the background',
  ...
  'phone.wifi': 'Only on an unmetered connection',
  'phone.wifiHint': 'A timed run waits for a connection nobody pays for by the megabyte. Android is asked, so a wifi network marked as metered counts as well.',
  'phone.heldCharging': 'Timed runs are waiting, because this phone is not charging.',
  'phone.heldMetered': 'Timed runs are waiting, because this connection is metered.',
...
export const de: Translations = {
  ...
  'phone.accessOn': 'ArrowLoop erreicht die Ordner, auf die ein Auftrag zeigt.',
  'phone.accessOff': 'Android hält jede App aus den Ordnern jeder anderen App heraus. Ohne diese Berechtigung erreicht ein Auftrag nur die kleine Ecke, die dieser App gehört, und dort legt die Kamera nichts ab.',
  'phone.accessAsk': 'Dateizugriff erlauben',
  ...
  'phone.notifyOn': 'Der Motor darf sagen, wann ein Lauf fertig ist und wann einer schiefgegangen ist.',
  'phone.notifyOff': 'Ohne sie erfährst du von einem Lauf, der um drei Uhr nachts gescheitert ist, erst Tage später.',
  'phone.notifyAsk': 'Benachrichtigungen erlauben',
  'phone.doze': 'Im Hintergrund laufen',
  'phone.dozeOn': 'Android lässt zeitgesteuerte Läufe in Ruhe.',
  ...
  'phone.dozeAsk': 'Laufen im Hintergrund erlauben',
  ...
  'phone.wifi': 'Nur über eine kostenfreie Verbindung',
  'phone.wifiHint': 'Ein zeitgesteuerter Lauf wartet auf eine Verbindung, die niemand nach Megabyte bezahlt. Gefragt wird Android, also zählt auch ein WLAN, das als kostenpflichtig markiert ist.',
