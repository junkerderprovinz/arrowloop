...
export const en = {
  ...
  'dupes.unhashable': 'Files that could not be hashed, and so were not compared: {count}.',
...
export const de: Translations = {
  ...
  'dupes.unhashable': 'Dateien ohne Prüfsumme, die deshalb nicht verglichen wurden: {count}.',
