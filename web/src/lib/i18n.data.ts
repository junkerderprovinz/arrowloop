...
export const de: Translations = {
  ...
  'opt.host': 'Server',
  'opt.url': 'Adresse',
  'opt.urlHint': 'Die vollstaendige Webadresse des Speichers, so wie sie im Browser steht. Bei einer Cloud endet sie meist auf einem Pfad wie /remote.php/dav/files.',
  'opt.userHint': 'Der Kontoname, mit dem du dich anmeldest. Nicht der Anzeigename und nicht die E-Mail, ausser der Dienst meldet dich damit an.',
  'opt.passHint': 'Das Passwort dieses Kontos. Wo der Dienst App-Passwoerter oder Token anbietet, nimm eines davon: es laesst sich einzeln zurueckziehen, ohne das echte Passwort zu aendern.',
  'opt.hostHint': 'Name oder IP des Rechners, ohne http und ohne Pfad. Zum Beispiel fileserver oder 192.168.1.20.',
  'opt.portHint': 'Nur noetig, wenn der Dienst nicht auf seinem ueblichen Port liegt. Leer gelassen nimmt er den Standard.',
  'opt.tokenHint': 'Der Token, den der Dienst fuer diese App ausgestellt hat. Er wird nur einmal angezeigt, also ganz kopieren und auf ein Leerzeichen am Ende achten.',
  'opt.accessKeyHint': 'Die Schluessel-ID des Objektspeichers, die kuerzere Haelfte des Paares. Sie benennt das Konto und ist fuer sich allein kein Geheimnis.',
  'opt.secretKeyHint': 'Die geheime Haelfte des Paares, einmalig beim Anlegen angezeigt. Wer sie hat, hat denselben Zugriff wie du.',
  'opt.endpointHint': 'Nur bei einem Speicher, der nicht Amazon ist: die Adresse deines eigenen Servers, zum Beispiel http://192.168.1.20:9000.',
  'opt.regionHint': 'Die Region, in der der Eimer liegt. Selbst betriebene Speicher nehmen hier meist jedes Wort, und das aus ihrer Einrichtung ist die sichere Wahl.',
  'opt.port': 'Port',
  'opt.domain': 'Domäne',
