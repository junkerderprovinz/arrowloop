...
export const en = {
  ...
  'engine.backupConfirm': 'Replace every job and every setting with {file}? The setup on this machine goes, and it does not come back unless you have a copy of it.',
...
export const de: Translations = {
  ...
  'engine.backupConfirm': 'Alle Aufträge und alle Einstellungen durch {file} ersetzen? Die Einrichtung auf diesem Rechner ist dann weg, und sie kommt nur zurück, wenn du eine Kopie davon hast.',
  ...
  'jobs.resume': 'Auftrag fortsetzen',
