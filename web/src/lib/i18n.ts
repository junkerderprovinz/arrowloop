...
export const en = {
  ...
  'live.idle': 'Nothing is running. A job that starts appears here while it works.',
  'live.hint': 'What the engine is doing this second: which job, which file, how far. It arrives as it happens rather than being asked for, so a run that is moving looks different from one that is stuck.',
  'schedule.off': 'On request',
...
export const de: Translations = {
  ...
  'settings.about': 'Über',
  'live.title': 'Gerade jetzt',
  'live.idle': 'Es läuft nichts. Ein Auftrag, der startet, erscheint hier, solange er arbeitet.',
  'live.hint': 'Was der Motor in dieser Sekunde tut: welcher Auftrag, welche Datei, wie weit. Es kommt an, während es passiert, statt abgefragt zu werden, also sieht ein Lauf, der vorankommt, anders aus als einer, der hängt.',
  'schedule.off': 'Auf Anforderung',
