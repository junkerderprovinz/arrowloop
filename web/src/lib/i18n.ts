...
export const en = {
  ...
  'targets.pickNoMatch': 'Nothing here matches “{q}”.',
  'targets.pickSearch': 'Search providers',
  'opt.user': 'User name',
  'opt.pass': 'Password',
  'opt.host': 'Server',
  'opt.url': 'Address',
...
export const de: Translations = {
  ...
  'targets.pickNoMatch': 'Hier passt nichts zu „{q}“.',
  'targets.pickSearch': 'Anbieter suchen',
