...
// Solana are the exception, see donateMarks.css). Under the pointer the tile
// takes the coin's colour, the disc its ink through --mark-ink and the symbol
// the tile's colour through --mark-cut, so the coin shows reversed ("Brand
// tiles" in GlimStone). PayPal and Buy Me a Coffee sit beside a label on a
// filled button and take the label's ink.
...
const COINS: Record<string, ReactNode> = {
  btc: (
    <>
      <circle cx="16" cy="16" r="16" fill="var(--mark-ink, #F7931A)" />
      <path
        fill="var(--mark-cut, #FFF)"
        fillRule="nonzero"
  ...
  eth: (
    <>
      <circle cx="16" cy="16" r="16" fill="var(--mark-ink, #627EEA)" />
      {/* Three tones of white make the faces of Ethereum's solid. */}
      <g fill="var(--mark-cut, #FFF)" fillRule="nonzero">
  ...
  usdt: (
    <>
      <circle cx="16" cy="16" r="16" fill="var(--mark-ink, #26A17B)" />
      <path
        fill="var(--mark-cut, #FFF)"
  ...
  usdc: (
    <>
      ...
      <circle cx="16" cy="16" r="16" fill="var(--mark-ink, #2775CA)" />
  ...
  bnb: (
    <>
      <circle cx="16" cy="16" r="16" fill="var(--mark-ink, #F3BA2F)" />
      <path
        fill="var(--mark-cut, #FFF)"
  ...
  sol: (
    <>
      ...
      <circle cx="16" cy="16" r="16" fill="var(--mark-ink, var(--coin-sol-disc))" />
      <defs>
      ...
      <path
        fill="var(--mark-cut, url(#coin-sol-bars))"
  ...
  sui: (
    <>
      ...
      <circle cx="16" cy="16" r="16" fill="var(--mark-ink, #4DA2FF)" />
  ...
  xrp: (
    <>
      ...
      <circle cx="16" cy="16" r="16" fill="var(--mark-ink, var(--coin-xrp-disc))" />
      <path
        fill="var(--mark-cut, var(--coin-xrp-ink))"
 ...
 * button paints its mark in one ink, which would turn a knocked-out letter on a
 * disc into a plain blob. The box is a square crop tight to the measured ink.
 */
const BTC_LETTER =
