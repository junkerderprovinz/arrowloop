...
- **Three motion levels and a hidden fourth**, from off to wild and storm, in the browser and on the phone, where cards fly in on every tab and a page springs back at its edges. The system's reduced-motion setting always wins.
